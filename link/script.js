...
if (keyword.includes(extraida)) {
    ...
    if (sessionStorage.getItem("setPagina")) {
        ...
        document.getElementById("LINK").innerHTML = '<div class="card-body text-center"><p><b>Wait a moment please...</b></p><h2 text-center id="titulo"></h2><button btn-captcha="" class="btn btn-primary" id="enlacecaptcha botonLink" m-2="" style="width: 300px;" disabled="disabled"><b>Please wait ... <span id="timer">20</span></b></button></div>';
