    ...
    var timer = $('#timer');
                window.setTimeout(function () {
                    ...
                    tid = setInterval(function () {
                        ...
                        if (time <= 0) {
                            clearInterval(tid); 
                            document.getElementById("LINK").innerHTML = '<section class="content-container" style="height: auto;"><div class="card"></br><div class="card-body text-center"><p><b>Please solve the captcha below to proceed to the destination page.</b></p><center><div id="adsContenedor"></div></center></br><div class="g-recaptcha m-2" data-callback="CaptchaChecked" data-sitekey="6LeYowYaAAAAAB97jxMiic4E6kwBWjD3_Zvxdmin" style="display: inline-block;"></div></div></br><center><div id="adsContenedor2"></div></center><div style="text-align: center;"><button onClick="getLink();" btn-captcha="" class="btn btn-primary" disabled="disabled" id="enlacecaptcha" m-2="" style="width: 300px;"><b>'+e+'</b></button></div><br /></div><div id="captchascript"></div></section>';
                            captcha();
                            setAdsUp();
                            setAdsDown();
                        }
