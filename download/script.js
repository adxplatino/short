...
if (keyword.includes(extraida)) {
 ...
 if (sessionStorage.getItem("setPagina") === "?coleccion-de-circuitos-de-electronica") {
        var elemento = document.getElementsByClassName("entry-title")[0];
        elemento.innerHTML = "Descarga Aqui La Colección de circuitos de electrónica Totalmente Gratis";
        ...
        var elemento = document.getElementsByClassName("entry-title")[0];
        elemento.innerHTML = "Descarga Aqui El Manual de Electrónica Básica Totalmente Gratis";
